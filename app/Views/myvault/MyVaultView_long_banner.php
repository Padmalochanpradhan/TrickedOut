    ...
    <div class="col-md-12 grid-margin">
      ...
      <div class="row" style="margin-top:80px;">
        <div class="col-lg-12 mt-3">
          <div style="background:url(<?= base_url('assets/images/bg2.png') ?>);background-size:cover" class="p-2 text-white">
            <div class="p-4">
              ...
              <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                <div class="float-left grad1 p-2">
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                      <img src="<?= base_url('assets/images/current.svg') ?>" / width="70">
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row" id="category_list_div_id">
            <?php foreach($trickCategoryList AS $trickCategory){ ?>
              <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                <div class="container1">
                  <a href="<?php echo base_url()?>/CategoryTricks/<?php echo $trickCategory->id?>">
                    <?php if($trickCategory->category_icon){?>
                      <img src="<?= base_url('trick_categary_image/'.$trickCategory->category_icon) ?>?v=3" class="img_style_vault">
                     <?php }else{ ?>
                ...
                <div class="text-center mb-4" style="color:#58595b;text-align:center;font-size:18px;"><?php echo $trickCategory->category_name; ?></div>
              </div>
