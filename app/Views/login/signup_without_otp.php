...
<body class="login_bg">
  <div class="px-4">
    <div class="row">
      <div class="back_blue">
        <form action="<?= base_url('signup_one_page') ?>" method="POST" onsubmit="return signupFormSubmit();">  
...
//     let price = $(this).data("monthly-price");

//     $(this).find(".price-text").html(
//       `$${parseFloat(price).toFixed(2)} <span class="fs-7 text-white">/month</span>`
//     );

//     $(this).find(".plan-type").text("-Monthly");
//   });
// });
...
//   $(".plan-card").each(function () {
//     let price = $(this).data("yearly-price");

//     $(this).find(".price-text").html(
//       `$${parseFloat(price).toFixed(2)} <span class="fs-7 text-white">/year</span>`
//     );

//     $(this).find(".plan-type").text("-Yearly");
//   });
// });
...
//     if (!price || price == 0) {
//       $(this).find(".price-text").html(`<span>No yearly plan</span>`);
//     } else {
//       $(this).find(".price-text").html(
//         `$${parseFloat(price).toFixed(2)} <span class="fs-7 text-white">/year</span>`
//       );
...
//     // update selected plan hidden field
//     if($(this).hasClass("border2")){
//       $("#price_id").val(priceId);
//     }
  ...
  $.ajax({
    ...
    success: function(res){
      if(res.status){
        ...
        $("#otp_msg").css("color","green").html(res.message);
        //alert(res.message);
      }
    }
  });
